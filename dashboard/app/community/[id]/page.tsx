  ...
  return (
    ...
    >
      ...
      <main style={{ maxWidth: 720, margin: '0 auto', padding: '28px 20px 80px' }}>
        <Link href='/community' style={{ fontSize: 13, color: '#888', textDecoration: 'none' }}>
          ← Back to community
        </Link>
          ...
          <>
            ...
            >
              <div style={{ fontSize: 12, color: '#888', marginBottom: 10 }}>
                <span style={{ fontWeight: 600, textTransform: 'uppercase', color: '#f97316' }}>
                  {post.category}
                </span>
                {' · '}
                {post.author_name}
              ...
              <h1 style={{ fontSize: 22, fontWeight: 700, margin: '0 0 16px', lineHeight: 1.3 }}>
                {post.title}
              </h1>
              <p
                style={{
