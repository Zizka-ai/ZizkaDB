...
const HERO_VALUE =
  "Make your agents auditable, reliable, and more deterministic.";
    ...
    >
      ...
      >
        <div style={container(1000)}>
          ...
          <p style={{ ...lead, marginBottom: 40 }}>
            ZizkaDB monitors, audits, and provides you the operational data. You
            correct your agent.
          </p>
      ...
      >
        <div style={container(960)}>
          ...
          <p style={lead}>
            Whether you are building a single agent or a multi-agent system,
            ZizkaDB fits how dev teams work.
          </p>
          ...
          >
            ...
            >
              ...
              >
                Log from Python, TypeScript, MCP, or REST. Self-host with Docker
                or use managed cloud. One API key per agent. No heavy infra
                project.
              </p>
            ...
            >
              ...
              >
                Prompt change broke behavior? Tool call ignored? Replay the full
                session, trace the decision chain, and find root cause without
                digging through logs.
              </p>
              <Link
                href="/signup"
                style={{ ...primaryBtn, fontSize: 14, padding: "12px 22px" }}
              >
                Start free trial
              </Link>
            </div>
            ...
            >
              ...
              >
                Deploy the complete ZizkaDB stack in your own cloud. Understand
                your multi-agent fleet with real-time operational insights so
                your team can correct failures before they reach users.
              </p>
              <Link
                href="/enterprise"
                style={{
      ...
      <section
        className="zdb-section"
        style={{ padding: "72px 40px", background: M.wash }}
      >
        <div style={container(960)}>
