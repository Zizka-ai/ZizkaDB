    ...
    <div style={{ fontFamily: 'Inter, system-ui, sans-serif', color: M.ink, background: '#fff' }}>
      ...
      >
        <div style={{ ...container(760), textAlign: 'center' }}>
          ...
          >
            ...
            <a href={GITHUB_URL} target='_blank' rel='noreferrer' style={blueBtn}>
              Self host
            </a>
            <button
              type='button'
      ...
      <section className='zdb-section' style={{ padding: '88px 40px', background: M.wash }}>
        <div style={container(960)}>
          ...
          <p style={lead}>
            Whether you are building a single agent or a multi-agent system, ZizkaDB fits how dev
            teams work.
          </p>
          ...
          >
            ...
            >
              ...
              >
                Log from Python, TypeScript, MCP, or REST. Self-host with Docker or use managed
                cloud. One API key per agent. No heavy infra project.
              </p>
              <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                <Link
                  href='/docs'
                  style={{ ...blueBtn, fontSize: 14, padding: '12px 20px', textDecoration: 'none' }}
                >
                  5-minute setup
                </Link>
                <button
            ...
            >
              ...
              >
                Prompt change broke behavior? Tool call ignored? Replay the full session, trace the
                decision chain, and find root cause without digging through logs.
              </p>
      ...
      <section
        id='pricing'
        className='zdb-section'
        style={{ padding: '88px 40px', background: M.wash }}
      >
          ...
          >
            {(
              ...
              >
                ...
                <div style={{ fontSize: 12, fontWeight: 800, color: '#000', marginBottom: 8 }}>
                  {plan.name}
                </div>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <span style={{ fontWeight: 500, color: '#000' }}>
            Open source operational database for AI agents
          </span>
        </div>
