...
const COLS = ['Capability', 'LangSmith', 'Mem0', 'Pinecone', 'ZizkaDB'] as const;
  ...
  return (
    ...
    >
      <div style={container(980)}>
        ...
        <p style={lead}>
          Vector DBs store embeddings. Traces show spans. ZizkaDB stores agent decisions, lineage,
          and drift.
        </p>
