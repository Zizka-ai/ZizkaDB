...
export function ConversationCompare() {
  return (
    <section id='demo' className='zdb-section' style={{ padding: '88px 40px', background: '#fff' }}>
      <div style={container(980)}>
        ...
        >
          <ComparePanel
            ...
            muted
            messages={[
              { role: 'Customer', text: 'Your bot told me refunds take 30 days. That is wrong.' },
  ...
  return (
    ...
    >
      <div
        style={{
          padding: '18px 20px',
          background: highlight ? 'linear-gradient(135deg, #fff7ed, #eff6ff)' : M.wash,
